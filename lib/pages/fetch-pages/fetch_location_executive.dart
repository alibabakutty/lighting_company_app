...
class FetchLocationExecutive extends StatefulWidget {
  const FetchLocationExecutive({super.key});

  @override
  State<FetchLocationExecutive> createState() => _FetchLocationExecutiveState();
}

class _FetchLocationExecutiveState extends State<FetchLocationExecutive> {
  List<AuthUser> _executives = [];
  ...
  Future<void> _fetchExecutives() async {
    ...
    try {
      ...
      final executives = await authProvider.getAllExecutives();
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Executives Locations'),
        actions: [
          IconButton(
